    ...
    return(
        <div className=" relative py-6 sm:py-8 lg:py-12 max-w-full">
            ...
            <div className="mx-auto max-w-screen-2xl px-6 md:px-16">
                <div className="flex flex-col items-center justify-between gap-5 rounded-lg p-4 sm:flex-row md:p-8 bg-[linear-gradient(90deg, rgba(38,38,38,1) 0%, rgba(38,38,38,0.5) 100%)] ">
                    <div>
