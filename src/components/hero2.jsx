...
import HeroImage from '../assets/img/Container.png'
    ...
    return(
      ...
      <div className="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
        ...
        <div className="flex flex-col gap-2.5 sm:flex-row sm:justify-center lg:justify-start font-Font">
          ...
          <NavLink to='/properties' className="inline-block rounded-lg bg-purple60 hover:bg-purple65 px-8 py-3 text-center text-sm font-semibold text-AbsoluteWhite outline-none ring-indigo-300 transition duration-100  focus-visible:ring active:text-gray-700 md:text-base no-underline">Browse Properties</NavLink>
        </div>
